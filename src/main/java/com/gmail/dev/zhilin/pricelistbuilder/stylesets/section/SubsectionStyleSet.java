...
public class SubsectionStyleSet extends StyleSet {

    public SubsectionStyleSet(Workbook workbook) {
        super(workbook);
    }
    ...
    protected CellStyle initializeFirstCellStyle(Workbook workbook) {
        ...
        style.setFillForegroundColor(new XSSFColor(new Color(220, 239, 244), null));
