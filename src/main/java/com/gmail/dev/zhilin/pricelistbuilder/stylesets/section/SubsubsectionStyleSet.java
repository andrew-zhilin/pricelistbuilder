...
public class SubsubsectionStyleSet extends StyleSet {

    public SubsubsectionStyleSet(Workbook workbook) {
        super(workbook);
    }
    ...
    protected CellStyle initializeFirstCellStyle(Workbook workbook) {
        ...
        style.setFillForegroundColor(new XSSFColor(new Color(250, 217, 194), null));
